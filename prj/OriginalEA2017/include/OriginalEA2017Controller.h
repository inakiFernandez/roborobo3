...
#ifndef ORIGINALEA2017CONTROLLER_H
#define ORIGINALEA2017CONTROLLER_H
...
class OriginalEA2017Controller : public Controller
{
private:
    int _iteration;
...
public:
    ...
    OriginalEA2017Controller(RobotWorldModel *wm);
    ~OriginalEA2017Controller();
